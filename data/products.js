const BASE_PRODUCTS = [
  { name: "Oud for Glory", brand: "Lattafa", category: "Unisex", price: "$6.000", description: "Una propuesta intensa y amaderada para quienes buscan una fragancia con presencia.", image: "capture_260709_225724.png", variants: [{ size: "5 ml", price: "$6.000" }, { size: "10 ml", price: "$10.000" }] },
  { name: "Attar Al Wesal Gold", brand: "Al Wataniah", category: "Unisex", price: "$6.500", description: "Dulce y envolvente, en formato decant para descubrirla antes de elegir más cantidad.", image: "capture_260709_225744.png", variants: [{ size: "5 ml", price: "$6.500" }, { size: "10 ml", price: "$11.000" }] },
  { name: "Khamrah", brand: "Lattafa", category: "Unisex", price: "$7.500", description: "Una fragancia cálida y especiada, de carácter elegante y persistente.", image: "capture_260709_225759.png", variants: [{ size: "5 ml", price: "$7.500" }, { size: "10 ml", price: "$12.000" }] },
  ...
  { name: "Club de Nuit Untold", brand: "Armaf", category: "Unisex", price: "$13.000", description: "Una fragancia sofisticada para quienes disfrutan aromas intensos y distintivos.", image: "capture_260709_225853.png", variants: [{ size: "5 ml", price: "$13.000" }, { size: "10 ml", price: "$22.000" }] },
  ...
  { name: "Club de Nuit Sillage", brand: "Armaf", category: "Unisex", price: "$10.000", description: "Una fragancia limpia y expresiva con una estela fácil de reconocer.", image: "capture_260709_225933.png", variants: [{ size: "5 ml", price: "$10.000" }, { size: "10 ml", price: "$19.000" }] },
  ...
  { name: "Amber Oud Gold Edition", brand: "Al Haramain", category: "Unisex", price: "$9.000", description: "Dulce, elegante y envolvente; disponible en decants para probarla a tu ritmo.", image: "capture_260709_230051.png", variants: [{ size: "5 ml", price: "$9.000" }, { size: "10 ml", price: "$14.000" }] },
  ...
  { name: "His Confession", brand: "Lattafa", category: "Hombre", price: "$7.000", description: "Profunda y elegante, con una presentación que anticipa su personalidad.", image: "capture_260709_230203.png", variants: [{ size: "5 ml", price: "$7.000" }, { size: "10 ml", price: "$10.000" }] },
  ...
  { name: "Club de Nuit Precieux I", brand: "Armaf", category: "Unisex", price: "$17.000", description: "Refinada y de presentación premium, para quienes buscan algo especial.", image: "capture_260709_230303.png", variants: [{ size: "5 ml", price: "$17.000" }, { size: "10 ml", price: "$28.000" }] },
  { name: "Xerjoff Erba Pura", brand: "Xerjoff", category: "Unisex", price: "$28.000", description: "Una fragancia intensa, elegante y de perfil frutal para ocasiones especiales.", image: "capture_260709_230331(1).png", variants: [{ size: "5 ml", price: "$28.000" }, { size: "10 ml", price: "$47.000" }] },
  ...
  { name: "Vulcan Feu", brand: "French Avenue", category: "Unisex", price: "$8.000", description: "Intensa y llamativa, para quienes buscan una fragancia diferente.", image: "capture_260709_230559(1).png", variants: [{ size: "5 ml", price: "$8.000" }, { size: "10 ml", price: "$14.000" }] },
