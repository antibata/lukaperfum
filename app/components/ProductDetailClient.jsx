      ...
      <main>
        <section className="product-detail"><div className="container product-detail-grid">
          ...
          <div className="detail-copy">
            ...
            <div className="detail-actions">{product.availability === "Sin stock" ? <button className="button" type="button" disabled>Sin stock</button> : <a className="button" href={whatsappUrl(message)} target="_blank" rel="noopener noreferrer">Pedir por WhatsApp</a>}</div>
